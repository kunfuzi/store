...
<?php echo $this->Form->create('Preparat'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Preparat'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Preparat.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Preparat.id'))); ?></li>
